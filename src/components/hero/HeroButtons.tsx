  ...
  return (
    <div className="flex flex-col gap-6 w-full lg:w-auto mt-0">
      <div className="flex flex-col sm:flex-row items-center gap-4">
        <button className="w-full sm:w-auto px-10 h-14 font-semibold text-white bg-[#5B52F5] hover:opacity-90 rounded-lg transition-all flex items-center justify-center gap-2 group">
          Get Started Free 
          <ArrowRight size={20} className="transition-transform group-hover:translate-x-1" />
        </button>
        <button className="w-full sm:w-auto px-10 h-14 font-semibold text-gray-700 bg-white hover:bg-gray-50 border border-gray-200 rounded-lg transition-all flex items-center justify-center gap-2 group">
          See Features 
